...
class PlayState extends FlxState
{
	...
	inline static private var SAVE_DATA:String = "NARROWJUMP";
	...
	override public function create():Void
	{
		...
		_scoreDisplay.color = 0xffffffff;
		...
		_highScore = new FlxText(0, 60, FlxG.width, "");
		_highScore.alignment = CENTER;
		_highScore.color = 0xffffffff;
		add(_highScore);
		...
		_bounceLeft.loadGraphic(Reg.getBounceImage(FlxG.height - 34), true, 4, FlxG.height - 70);
		...
		_bounceRight.loadGraphic(Reg.getBounceImage(FlxG.height - 34), true, 4, FlxG.height - 70);
		...
		_spikeBottom.y = FlxG.height - _spikeBottom.height - 33;
		add(_spikeBottom);
